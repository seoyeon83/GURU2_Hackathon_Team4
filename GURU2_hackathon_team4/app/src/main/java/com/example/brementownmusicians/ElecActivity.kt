...
class ElecActivity : AppCompatActivity() {
    ...
    private val sounds = listOf(
        Pair(R.id.elLine1, R.raw.elec1),
        Pair(R.id.elLine2,R.raw.elec2),
        Pair(R.id.elLine3,R.raw.elec3),
        Pair(R.id.elLine4,R.raw.elec4),
        Pair(R.id.elLine5,R.raw.elec5),
        Pair(R.id.elLine6,R.raw.elec6),
    )
