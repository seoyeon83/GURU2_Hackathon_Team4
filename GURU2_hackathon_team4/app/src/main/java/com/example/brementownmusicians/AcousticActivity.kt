...
class AcousticActivity : AppCompatActivity() {
    ...
    private val sounds = listOf(
        Pair(R.id.acLine1, R.raw.acoustic1),
        Pair(R.id.acLine2,R.raw.acoustic2),
        Pair(R.id.acLine3,R.raw.acoustic3),
        Pair(R.id.acLine4,R.raw.acoustic4),
        Pair(R.id.acLine5,R.raw.acoustic5),
        Pair(R.id.acLine6,R.raw.acoustic6),
    )
